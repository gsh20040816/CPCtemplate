...
3.6.1 查询区间不同数、3.6.3 树上路径点权第 k 小、3.6.4 树状数组套主席树支持动态修改均为不同功能；3.6.3 由下述 tree_path_kth.hpp 补齐，其余两项仍待补。新增 tests/persistent_kth_application.py 对两份实际 P3834 打包程序以排序切片作参照，包含重复值、单点区间与 int64 两端。
