...
登记文件为 usage-examples.json，生成器 tools/usage_examples.py 输出 usage/*.cpp 和逐模板覆盖表 USAGE-COVERAGE.md / usage-coverage.json。新模板自动进入待补清单，未补项不隐去。当前 12 份示例覆盖 11 个模板，BiconnectedCore 包含点双和边双两题；其余继续补齐。
