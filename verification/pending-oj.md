...
- `verify/luogu/P4174.classic.cpp`
- `verify/luogu/P4174.compact.cpp`
...
- P3834 动态版验证码已由用户当次授权处理，记录 297520290 已 AC；传统版尚待提交。
...
- P3919 双风格已 AC：动态版 297520221，传统版 297520224；P3834 双风格打包程序已检查区间第 k 小，动态版已 AC（297520290），传统版在线评测仍待补。两类模板分别验证，不混用版本语义。
...
- P3834 动态版验证码已处理，记录 297520290 获得 100 分 AC；传统版尚未提交。两份打包程序的排序切片对拍见 verification/persistent-kth-driver-tests.txt。
