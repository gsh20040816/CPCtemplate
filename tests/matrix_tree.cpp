...
int main()
{
    ...
    cout << "Matrix tree independent exhaustive weighted edge sets, all "
            "roots/directions, parallel loops, signed weights and 220-vertex Cayley "
            "families PASS\n";
}
