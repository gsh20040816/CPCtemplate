...
for style in ['compact', 'classic']:
    ...
    print(f'P3379 lifting {style}: {len(cases)} cases including n=q=500000 passed; recursive driver executed on 256MB pthread stack')
...
for style in ['compact', 'classic']:
    ...
    assert list(map(int, result.stdout.split())) == expected
    print(f'POJ1330 lifting {style}: directed edges, inferred roots, shuffled input, 71 datasets and n=10000 passed')
