...
需要 GCC、C++20 和 Boost（只用于测试中的独立精确几何参考）。每份可提交代码必须与测试及打印代码同源。OJ 证据见 [oj.json](verification/oj.json)：两套最大流和动态树分别已在洛谷 P3376、P3690 获得 100 分 AC；动态版有序 Treap 已在 P3369 获得 100 分 AC；其余模块不声称 OJ 已通过。
