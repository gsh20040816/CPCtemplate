...
for name in ['local-tests.txt','sanitizer-tests.txt']:
 ...
 if any(marker not in s for marker in ['lowlink removal oracle PASS', 'Sequence treap / vector oracle PASS', 'Tagged GCD treap / vector oracle and recycled capacity PASS', 'Blossom exhaustive n<=6, subset DP, duplicate edges and dense graph PASS', 'BM exhaustive minimality, recurrence holdout and uint64 matrix oracle PASS', 'Tarjan SCC exhaustive digraphs, reachability and condensation oracle PASS', 'Biconnected subset/removal oracles and block/bridge forests PASS', 'PAM exhaustive substrings, suffix links, repeated counts and 200000 letters PASS', 'Centroid distance/Floyd oracle, zero weights, overflow boundary and recursive chain PASS', 'DSU-on-tree ancestor histogram, reroot/reset, recursive chain and star PASS', 'Affine segment tree int128 oracle, composition, modulus one and large range PASS', 'Virtual tree all-pairs LCA closure, compressed paths, reroot and recursive chain PASS', 'P2495 dual-style bundled drivers / exhaustive edge cuts PASS']) or 'error:' in s or 'runtime error:' in s:raise SystemExit('Incomplete/failing log: '+name)
