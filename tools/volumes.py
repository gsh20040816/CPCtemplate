...
groups = {
    'data-structures': ('数据结构', 'hash_table data_structure modified_mo position_basis basis_intersection affine_segment_tree persistent_array persistent_range dynamic_kth persistent_distinct treap splay gcd_sequence'),
